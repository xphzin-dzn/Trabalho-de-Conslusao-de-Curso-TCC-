 ...
 * @returns
 */
export declare const createDeferredCachedValue: <T>(cb: () => T) => ICachedValue<T>;
 ...
 * ```
 */
export declare function fnCall<F extends (...args: any) => any, T>(fn: F, thisArg: T, ...args: Parameters<F>): ReturnType<F>;
 ...
 * ```
 */
export declare function getDeferred<R, F extends (...args: any[]) => R>(cb: F, argArray?: Parameters<F>): ICachedValue<R>;
 ...
 * ```
 */
export declare function getLazy<T, F extends (...args: any[]) => T = () => T>(cb: F, argArray?: Parameters<F>): ILazyValue<T>;
 ...
 * ```
 */
export declare function getWritableDeferred<R, F extends (...args: any[]) => R = () => R>(cb: F, argArray?: Parameters<F>): ICachedValue<R>;
 ...
 * ```
 */
export declare function getWritableLazy<T, F extends (...args: any[]) => T = () => T>(cb: F, argArray?: Parameters<F>): ILazyValue<T>;
 ...
 */
export declare interface ISafeReturn<T extends (...args: any) => R, R = SafeReturnType<T>> {
    /**
 ...
 * ```
 */
export declare const isAsyncFunction: (value: any) => value is Function;
 ...
 * ```
 */
export declare const isAsyncGenerator: (value: any) => value is AsyncGeneratorFunction;
 ...
 * ```
 */
export declare function isElementLike(value: any): boolean;
 ...
 * ```
 */
export declare const isGenerator: (value: any) => value is GeneratorFunction;
 ...
 * ```
 */
export declare const isMap: <K = any, V = any>(value: any) => value is Map<K, V>;
 ...
 * ```
 */
export declare function isMapLike<K = any, V = any>(value: any): value is Map<K, V>;
 ...
 * ```
 */
export declare const isSet: <T = any>(value: any) => value is Set<T>;
 ...
 * ```
 */
export declare function isSetLike<T = any>(value: any): value is Set<T>;
 ...
 * ```
 */
export declare const isWeakMap: <K extends object = object, V = any>(value: any) => value is WeakMap<K, V>;
 ...
 * ```
 */
export declare const isWeakSet: <T extends object = object>(value: any) => value is WeakSet<T>;
 ...
 */
export declare const objCreate: (obj: any, properties?: PropertyDescriptorMap & ThisType<any>) => any;
 ...
 * ```
 */
export declare const objFromEntries: ObjFromEntriesFn;
 ...
 * @group Object
 */
export declare type ObjFromEntriesFn = {
    /**
 ...
 * ```
 */
export declare const objGetOwnPropertyDescriptors: (obj: any) => PropertyDescriptorMap;
 ...
 * ```
 */
export declare const objGetOwnPropertyNames: (obj: any) => string[];
 ...
 * ```
 */
export declare const objGetOwnPropertySymbols: (obj: any) => symbol[];
 ...
 * ```
 */
export declare const objIs: (value1: any, value2: any) => boolean;
 ...
 */
export declare const objIsExtensible: (obj: any) => boolean;
 ...
 * ```
 */
export declare const objIsFrozen: (obj: any) => boolean;
 ...
 * ```
 */
export declare const objIsSealed: (obj: any) => boolean;
 ...
 */
export declare const objPreventExtensions: <T>(obj: T) => T;
 ...
 * ```
 */
export declare const objPropertyIsEnumerable: (obj: any, prop: PropertyKey) => boolean;
 ...
 */
export declare const objSetPrototypeOf: (obj: any, proto: object) => any;
 ...
 * ```
 */
export declare const objValues: <T = any>(value: {} | {
    [s: string]: T;
} | ArrayLike<T>) => T[];
 ...
 * @returns True if the values are the same value, false otherwise
 */
export declare function polyObjIs(value1: any, value2: any): boolean;
 ...
 * ```
 */
export declare function safe<F extends (...args: unknown[]) => R, R = any>(func: F, argArray?: any[]): ISafeReturn<F, R>;
 ...
 * ```
 */
export declare function safeGet<T = boolean, F extends (...args: any[]) => T = () => T>(cb: F, defValue: T, argArray?: Parameters<F>): T;
 ...
 * ```
 */
export declare function safeGetDeferred<T, F extends (...args: any[]) => T = () => T>(cb: F, defValue: T, argArray?: Parameters<F>): ICachedValue<T>;
 ...
 * ```
 */
export declare function safeGetLazy<T = boolean, F extends (...args: any[]) => T = () => T>(cb: F, defValue: T, argArray?: Parameters<F>): ILazyValue<T>;
 ...
 * ```
 */
export declare function safeGetWritableDeferred<T, F extends (...args: any[]) => T = () => T>(cb: F, defValue: T, argArray?: Parameters<F>): ICachedValue<T>;
 ...
 * ```
 */
export declare function safeGetWritableLazy<T = boolean, F extends (...args: any[]) => T = () => T>(cb: F, defValue: T, argArray?: Parameters<F>): ILazyValue<T>;
 ...
 * ```
 */
export declare function setGlobalTimeoutOverrides(overrideFn?: TimeoutOverrideFn | TimeoutOverrideFuncs): void;
 ...
 * ```
 */
export declare function setTimeoutOverrides(overrideFn?: TimeoutOverrideFn | TimeoutOverrideFuncs): void;
